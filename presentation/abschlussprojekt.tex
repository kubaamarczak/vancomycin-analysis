...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.65\linewidth]{corrplot nierenmarker.png}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{VancomycinNiereGewicht.png}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{KomorxMort.png}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{NephroxMort.png}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.85\linewidth]{ Rplot.png}
